---
layout: post
title: "React-Native 样式小结"
subtitle: "React-Native的样式与CSS不完全相同"
date:  2019-02-28
author: "cici"
...
React-Native 的样式基本上是实现了 CSS 的一个子集，很多写法和布局与之前写WEB的CSS不同，简单总结一下。

>在 React Native 中样式名基本上是遵循了 web 上的 CSS 的命名，只是按照 JS 的语法要求使用了驼峰命名法，例如将background-color改为backgroundColor。
...
```
转载自[React-Native 样式指南](https://github.com/doyoe/react-native-stylesheet-guide)